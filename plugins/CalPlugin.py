...
class CalPlugin(PlBase.Plugin):
    ...
    def update(self, statusDict):
        ...
        try:
            hct1 = statusDict.get(DomeffPlugin.aliases[0])
            hct2 = statusDict.get(DomeffPlugin.aliases[1])
            hal1 = statusDict.get(DomeffPlugin.aliases[2])
            hal2 = statusDict.get(DomeffPlugin.aliases[3])
            rgl1 = statusDict.get(DomeffPlugin.aliases[4])
            rgl2 = statusDict.get(DomeffPlugin.aliases[5])
            hct1_amp = statusDict.get(DomeffPlugin.aliases[6])
            hct2_amp = statusDict.get(DomeffPlugin.aliases[7])
            hal1_amp = statusDict.get(DomeffPlugin.aliases[8])
            hal2_amp = statusDict.get(DomeffPlugin.aliases[9])
